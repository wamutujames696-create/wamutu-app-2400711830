...
<head>
    ...
    <title>Notifications — Campus Service Portal</title>
    ...
    <div class="pt-16 sm:pl-64 min-h-screen flex flex-col">
        <main class="flex-1 pb-8 px-4 sm:px-8 lg:px-10 pt-6">
            ...
            <div class="max-w-3xl space-y-3">
                <a href="requests/show.html" class="block bg-white border border-blue-200 rounded-xl p-4 hover:bg-slate-50 shadow-sm">
                ...
                <a href="requests/show.html" class="block bg-white border border-slate-200 rounded-xl p-4 hover:bg-slate-50 shadow-sm">
                    <div class="flex gap-3">
