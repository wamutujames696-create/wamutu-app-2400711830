...
<head>
    ...
    <title>New ticket — Campus Service Portal</title>
        ...
        <main class="flex-1 pb-8 px-4 sm:px-8 lg:px-10 pt-6">
            ...
            <form action="show.html" method="get" class="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm max-w-3xl">
                ...
                <div class="px-4 py-4 bg-white border-t border-slate-200 flex justify-between">
                    <a href="index.html" class="inline-flex items-center px-4 py-2 bg-white border border-slate-200 rounded-lg text-sm font-medium text-slate-600 hover:bg-slate-100"><i data-lucide="x" class="w-4 h-4 mr-2"></i>Cancel</a>
